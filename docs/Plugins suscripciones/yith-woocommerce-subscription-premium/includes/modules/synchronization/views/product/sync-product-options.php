...
<?php if ( 'full' === get_option( 'ywsbs_sync_first_payment', 'no' ) ) : ?>
	<div class="ywsbs-product-metabox-field ywsbs-synchronize-ref-date" data-deps-on="_ywsbs_price_time_option" data-deps-val="weeks|months|years">
		<label for="_ywsbs_synchronize_ref_date"><?php esc_html_e( 'Calculate the recurring payment date based on', 'yith-woocommerce-subscription' ); ?></label>
		<div class="ywsbs-product-metabox-field-container">
			<div class="ywsbs-product-metabox-field-content">
				<select name="_ywsbs_synchronize_ref_date" id="_ywsbs_synchronize_ref_date">
