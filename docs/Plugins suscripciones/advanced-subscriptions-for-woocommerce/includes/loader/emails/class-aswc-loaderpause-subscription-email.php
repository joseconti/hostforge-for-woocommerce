...
if ( ! class_exists( 'Aswc_LoaderPause_Subscription_Email' ) ) {
	 ...
	 * @subpackage Aswc_Loader/email
	 */
	class Aswc_LoaderPause_Subscription_Email extends WC_Email {
		/**
		...
		public function __construct() {
			...
			$this->id    = 'aswc_pause_subscription';
			$this->title = __( 'Paused Subscription Email Notification', 'advanced-subscriptions-for-woocommerce' );

			$this->description = __( 'This Email Notification Send if any subscription is Paused', 'advanced-subscriptions-for-woocommerce' );

						$this->template_html  = 'aswc-pause-subscription-email-template.php';
						$this->template_plain = 'plain/aswc-pause-subscription-email-template.php';
		...
		public function get_default_subject() {
			return __( 'Paused Susbcription Email {site_title}', 'advanced-subscriptions-for-woocommerce' );
		}
		...
		public function get_default_heading() {
			return __( 'Subscription Paused', 'advanced-subscriptions-for-woocommerce' );
		}
...
return new Aswc_LoaderPause_Subscription_Email();
