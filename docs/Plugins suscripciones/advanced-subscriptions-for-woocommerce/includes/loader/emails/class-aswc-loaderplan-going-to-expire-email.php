...
if ( ! class_exists( 'Aswc_LoaderPlan_Going_To_Expire_Email' ) ) {
	 ...
	 * @subpackage Aswc_Loader/email
	 */
	class Aswc_LoaderPlan_Going_To_Expire_Email extends WC_Email {
		/**
		...
		public function __construct() {
			...
			$this->id             = 'aswc_plan_going_expire';
			$this->title          = __( 'Subscription Going To Expire Email Notification', 'advanced-subscriptions-for-woocommerce' );
			$this->customer_email = true;
			$this->description    = __( 'This Email Notification Send to customer if any subscription plan going to expire', 'advanced-subscriptions-for-woocommerce' );

						$this->template_html  = 'aswc-plan-going-to-expire-email-template.php';
						$this->template_plain = 'plain/aswc-plan-going-to-expire-email-template.php';
		...
		public function get_default_subject() {
			return __( 'Subscription going to expire', 'advanced-subscriptions-for-woocommerce' );
		}
...
return new Aswc_LoaderPlan_Going_To_Expire_Email();
