...
if ( ! class_exists( 'Aswc_LoaderReactivate_Subscription_Email' ) ) {
	 ...
	 * @subpackage Aswc_Loader/email
	 */
	class Aswc_LoaderReactivate_Subscription_Email extends WC_Email {
		/**
		...
		public function __construct() {
			...
			$this->id                         = 'aswc_reactivate_subscription';
			$this->title                      = __( 'Reactivate Subscription Email Notification', 'advanced-subscriptions-for-woocommerce' );
			$this->description                = __( 'This Email Notification Send if any subscription is Reactivated', 'advanced-subscriptions-for-woocommerce' );
						$this->template_html  = 'aswc-reactivate-subscription-email-template.php';
						$this->template_plain = 'plain/aswc-reactivate-subscription-email-template.php';
		...
		public function get_default_subject() {
			return __( 'Reactivated Susbcription Email {site_title}', 'advanced-subscriptions-for-woocommerce' );
		}
		...
		public function get_default_heading() {
			return __( 'Subscription Reactivated', 'advanced-subscriptions-for-woocommerce' );
		}
...
return new Aswc_LoaderReactivate_Subscription_Email();
