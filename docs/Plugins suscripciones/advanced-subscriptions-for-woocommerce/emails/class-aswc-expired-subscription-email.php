...
if ( ! class_exists( 'ASWC_Expired_Subscription_Email' ) ) {
	 ...
	 * @subpackage advanced-subscriptions-for-woocommerce/email
	 */
	class ASWC_Expired_Subscription_Email extends WC_Email {
		/**
		...
		public function __construct() {
						...
						$this->id = 'aswc_expired_subscription';
			$this->title          = __( 'Expired Subscription Email Notification', 'advanced-subscriptions-for-woocommerce' );
			$this->description    = __( 'This Email Notification Send if any subscription is Expired', 'advanced-subscriptions-for-woocommerce' );
			$this->template_html  = 'aswc-expired-subscription-email-template.php';
			$this->template_plain = 'plain/aswc-expired-subscription-email-template.php';
		...
		public function get_default_subject() {
			return __( 'Expired Susbcription Email {site_title}', 'advanced-subscriptions-for-woocommerce' );
		}
		...
		public function get_default_heading() {
			return __( 'Subscription Expired', 'advanced-subscriptions-for-woocommerce' );
		}
...
return new ASWC_Expired_Subscription_Email();
