...
<p><?php printf( esc_html__( 'A subscription [#%s] has been Activated From On-hold By Admin. Their subscription\'s details are as follows:', 'advanced-subscriptions-for-woocommerce' ), esc_html( $aswc_subscription ) ); ?></p>
