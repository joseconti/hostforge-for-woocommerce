...
// phpcs:enable PEAR.NamingConventions.ValidClassName.Invalid, Squiz.Commenting.ClassComment.Missing
	...
	public function aswc_export_button_html() {
		?>
		<a href="<?php echo esc_url( admin_url( 'admin.php?page=subscriptions_jc_for_woocommerce_menu&aswc_csv_export=aswc_csv_report' ) ); ?>" class="aswc_export_button button action" target="_blank"><?php esc_html_e( 'Export CSV', 'advanced-subscriptions-for-woocommerce' ); ?> </a>
		<?php
	}
	...
	public function aswc_add_renewal_payment_actions( $actions ) {
		global $theorder;
		if ( is_object( $theorder ) && 'yes' === $theorder->get_meta( 'aswc_renewal_order' ) && $theorder->has_status( array( 'pending' ) ) ) {
