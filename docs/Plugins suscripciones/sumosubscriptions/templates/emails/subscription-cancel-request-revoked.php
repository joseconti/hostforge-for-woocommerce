...
<p>
	...
	printf( esc_html__( 'Your request to revoke the subscription cancellation of #%s has been proccessed successfully.', 'sumosubscriptions' ), esc_html( sumo_get_subscription_number( $post_id ) ) ) ;
	?>
</p>
