...
<p>
	<?php
	/* translators: 1: subscription number 2: cancelled method 3: cancel scheduled date  */
	printf( wp_kses_post( __( 'Your request to cancel your subscription #%1$s has been submitted successfully. <br><strong>Cancel Method: </strong> %2$s(%3$s). <br>', 'sumosubscriptions' ) ), esc_html( sumo_get_subscription_number( $post_id ) ), esc_html( $requested_cancel_method ), esc_html( $cancel_scheduled_on ) ) ;
	?>
</p>
