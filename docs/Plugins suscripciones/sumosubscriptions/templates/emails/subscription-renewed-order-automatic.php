...
<p>
	...
	printf( esc_html__( 'Renewal of your Subscription #%1$s on %2$s has been successfully completed.', 'sumosubscriptions' ), esc_html( sumo_get_subscription_number( $post_id ) ), esc_html( get_option( 'blogname' ) ) ) ;
	?>
</p>
